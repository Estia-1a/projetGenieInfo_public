...
GIT_TOKEN="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"
g = Github(GIT_TOKEN)
...
for team in repositories:
    try:         
        ...
        contents = repoTarget.get_contents("src/features.c", ref="main")
        Path("result/"+team + ".c" ).write_bytes( base64.b64decode(contents.content ) )
        print( team + " Success! ")
        time.sleep(0.5)
